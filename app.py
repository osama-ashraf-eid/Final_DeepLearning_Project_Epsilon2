...
if uploaded_video is not None:
    ...
    if not os.path.exists(model_path):
        st.error("⚠ Model file not found! Please upload 'yolov8m-football_ball_only.pt' in the same folder.")
        st.stop()
    ...
    href = f'<a href="data:video/mp4;base64,{b64}" download="processed_football_video.mp4">⬇ Download Processed Video</a>'
